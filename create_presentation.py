...
def set_text_frame_properties(tf, font_size=16):
...
p.level = 1
set_text_frame_properties(tf2, font_size=16)
...
set_text_frame_properties(tf3, font_size=16)
...
p.level = 1
set_text_frame_properties(tf4, font_size=16)
...
set_text_frame_properties(tf5, font_size=16)
...
p.level = 1
set_text_frame_properties(tf6, font_size=16)
...
p.level = 1
set_text_frame_properties(tf7, font_size=16)
...
p.level = 1
set_text_frame_properties(tf8, font_size=16)
...
set_text_frame_properties(tf9, font_size=14)
...
set_text_frame_properties(tf10, font_size=14)
...
p.level = 1
set_text_frame_properties(tf11, font_size=16)
...
title12.text_frame.paragraphs[0].font.size = Pt(28)
...
p.level = 1
set_text_frame_properties(tf12, font_size=16)
...
title13.text_frame.paragraphs[0].font.size = Pt(28)
...
set_text_frame_properties(tf13, font_size=16)
...
set_text_frame_properties(tf14, font_size=18)
...
print("All text configured to fit within slide boundaries with reduced font sizes.")
print("Removed 'By [Name]' from all slides except the first slide.")
